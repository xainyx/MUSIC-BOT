...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      const youtubeLink = 'https://discord.gg/refanxo';
      const InstagramLink = 'https://www.instagram.com/xainyx_/';
      const { EmbedBuilder } = require('discord.js')
        const embed = new EmbedBuilder()
          ...
          url: 'https://discord.gg/refanxo'
            ...
            .setDescription(`__**About me**__:\n\n ▶️ anas AKA JOHAN , contact me on instagram  \n YouTube : ❤️ [REFANXO](${youtubeLink})\n Instagram : 💙 [xainyx_](${InstagramLink})`)
            .setTimestamp();
